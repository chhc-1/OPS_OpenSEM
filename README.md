...
oSEM, MRSEM, ISEM have been implemented. Note the version of ISEM in https://github.com/chhc-1/OpenSEM is currently bugged - it should not produce the correct Reynold's Stress Tensor. Periodic BCs are implemented only in the OpenSBLI scripts and MRSEM_mod in this repository. MRSEM_mod adds temperature fluctuations to MRSEM using Strong Reynold's Analogy.
...
SEM animations are in the "figures" folder; filesize has not been optimised for here.
